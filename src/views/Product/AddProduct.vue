               ...
               <div class="flex flex-wrap -m-4 lg:max-w-5xl mx-auto">
                  ...
                  <div class="p-4 md:w-2/3 w-full h-auto">
                     ...
                     <div class="bg-white px-5 py-5 rounded-lg shadow mb-5">
                        <div class="w-full">
                           <h4 class="text-sm text-gray-900 -mt-1 mb-1">
                              Nama Produk
                           </h4>
                           <input
                              v-model="product_name"
                              class="bg-white text-sm rounded border-2 border-gray-400 focus:outline-none focus:border-orange-500 px-3 py-2 w-full mb-5"
                              placeholder="Contoh: Nike E300"
                              type="text"
                           />
                           <h4 class="text-sm text-gray-900 -mt-1 mb-1">
                              Deskripsi
                     ...
                     <!-- Informasi Media -->
                     <div
                        v-show="variantToogle !== true"
                        class="bg-white px-5 py-5 rounded-lg shadow mb-5"
                     >
                        <div class="w-full">
                           <h4
                              class="text-md text-gray-900 font-semibold pt-2 pb-5 -mt-1 mb-1"
                           >
                              Media
                           </h4>
                           ...
                           <template v-if="product_images.length !== 0">
                              <div class="grid grid-cols-3 gap-2">
                                 ...
                                 >
                                    <div
                                       class="flex flex-wrap items-center justify-center w-full rounded-lg border border-gray-400 overflow-hidden"
                                       style="height: 195px"
                                    >
                                       <img
                                          :src="image.imageURL"
                                          width="152"
                                          class="w-48 h-48 object-contain object-center"
                                       />
                                    </div>
                                 </div>
                                 <div>
                                    ...
                                    >
                                       <svg
                                          class="w-8 h-8 -mt-1 mb-2 ionicon"
                     ...
                     >
                        <div class="w-full">
                           ...
                           <input
                              v-model.number="single_product_detail.harga_jual"
                              class="bg-white text-sm rounded border-2 border-gray-400 focus:outline-none focus:border-orange-500 px-3 py-2 w-full"
                              placeholder="Rp0.00"
                              type="text"
                           />
                        </div>
                     ...
                     <div class="bg-white px-5 py-5 rounded-lg shadow mb-5">
                        <div class="w-full">
                           ...
                           <input
                              v-model.number="single_product_detail.weight"
                              class="bg-white text-sm rounded border-2 border-gray-400 focus:outline-none focus:border-orange-500 px-3 py-2 w-full"
                     ...
                     <!-- Informasi Variant -->
                     <div
                        class="bg-white px-5 py-5 rounded-t-lg shadow border-b border-gray-200"
                        :class="variantToogle ? 'rounded-t-lg' : 'rounded-lg'"
                     >
                        <div class="w-full">
                           <h4
                              class="text-md text-gray-900 font-semibold pt-2 pb-5 -mt-1 mb-1"
                           ...
                           <div class="flex items-center">
                              <input
                                 id="checkbox"
                                 v-model="variantToogle"
                                 type="checkbox"
                                 class="form-checkbox h-5 w-5 text-orange-500 transition duration-150 focus:shadow-none border-2 border-orange-500 focus:border-orange-500 ease-in-out"
                              />
                              <label
                                 for="checkbox"
                     ...
                     <div
                        v-show="variantToogle"
                        class="bg-white px-5 py-5 rounded-b-lg shadow border-b border-gray-200"
                     >
                        <div class="w-full">
                           <div class="bg-gray-100">
                              <div
                                 class="flex items-center py-2 px-3 border-b border-gray-300"
                              >
                                 <div>
                                 ...
                                 <div class="ml-auto">
                                    <button
                                       @click="variantToogle = false"
                                       class="text-gray-800 hover:text-red-500 flex items-center focus:outline-none"
                                    >
                                       <svg
                                          class="ionicon w-5 w-5"
                                          xmlns="http://www.w3.org/2000/svg"
                                          viewBox="0 0 512 512"
                                       >
                                          <title>Close</title>
                              ...
                              <div class="px-5 py-5 mb-3">
                                 ...
                                 <input
                                    class="bg-white text-sm rounded border-2 border-gray-400 focus:outline-none focus:border-orange-500 px-3 py-2 w-full mb-3"
                                 ...
                                 <div class="inline-flex w-full mb-3">
                                    <input
                                       class="bg-white text-sm rounded border-2 border-gray-400 focus:outline-none focus:border-orange-500 px-3 py-2 w-full"
                                       placeholder="Contoh: Merah/Biru/XL/XXL"
                                       type="text"
                                    />
                                    <button
                                       @click="variantToogle = false"
                                       class="text-white bg-red-500 border-0 py-2 px-3 focus:outline-none hover:bg-red-600 rounded text-sm ml-1"
                                    >
                                       <svg
                                          class="ionicon w-5 w-5"
                                          xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 <button
                                    class="inline-flex items-center justify-center text-orange-500 border-dashed border-2 border-orange-500 py-2 px-3 focus:outline-none hover:bg-gray-200 rounded text-sm w-full"
                                 >
                                    <svg
                                       class="ionicon w-5 w-5"
                                       xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="p-4 md:w-1/3 w-full h-auto">
                     <div class="bg-white px-5 py-5 rounded-lg shadow mb-5">
                        <div class="w-full">
                           ...
                           <button
                              @click="createProduct"
                              class="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-sm w-full"
                           >
                              Simpan Produk
                           </button>
                        </div>
                     ...
                     >
                        <div class="w-full">
                           ...
                           <z-select
                              ...
                              placeholder="Pilih Departemen/Kategori"
                           >
                           </z-select>
                        </div>
                     </div>
   ...
   methods: {
      ...
      async createProduct() {
         const singleProductItem = {
            weight: parseInt(200),
            sku: this.sku,
            subdistrict_ids: JSON.stringify([1, 4]),
         };

         const singleProductPost = {
            brand_id: parseInt(1),
            category_id: parseInt(1),
            product_type_id: parseInt(1),
            product_kind_id: parseInt(1),
            name: this.product_name,
            description: this.desc,
            status: this.status,
            single_product_item: JSON.stringify(singleProductItem),
         };
         let singleProductForm = new FormData();
         this.product_images.forEach((file) => {
            singleProductForm.append('product_images', file, file.name);
         });
         singleProductForm.append('product', JSON.stringify(singleProductPost));
...
//     "product_type_id": 1,
//     "product_kind_id": 1,
//     "name": "single_product_1",
//     "description": "this is single product",
//     "status": "a",
//     "single_product_item": "{\"weight\":200,\"sku\":\"single_sku\",\"subdistrict_ids\":\"[9,8,7]\"}"
// }
      },
   },
};
